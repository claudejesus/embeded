...
#define ECHO_PIN 9
#define LED_PIN 13
#define BUTTON1_PIN  10// Car Exit
#define BUTTON2_PIN 12// Reset Parking Slots
...
void loop() {
  ...
  if (digitalRead(BUTTON2_PIN) == LOW) {
    ...
    //lcd.clear();
    //lcd.setCursor(0, 0);
    Serial.print("Slots Reset");
    Serial.print("Slots: ");
    Serial.print(parkingSlots);
    Serial.print("/ ");
    Serial.println(maxParkingSlots);
